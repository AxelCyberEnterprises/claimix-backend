"""
Django settings for claimix project.
...
SECRET_KEY = 'django-insecure-#o5*o&9ppz)4#6hw005%+#8kyw$!z3powi+pqb8#=yao-fxy=&'
...
WSGI_APPLICATION = 'claimix.wsgi.application'
